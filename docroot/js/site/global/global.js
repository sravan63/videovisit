...
document.write("<script type='text/javascript' src='/js/library/plugin/jquery.kwcPath.js'></script>");
// DEPENDENCIES - GLOBAL
...
( function() {
    ...
    var GoToExpiredPage = function() {
        location.href = $.kwcPath.SESSION_EXPIRED_PAGE;
    };
    
    // Redirects to the "session expired" page.
    var GoToExpiredPage = function() {
        location.href = $.kwcPath.ERROR_PAGE;
    };
    ...
    var ResetTimer = function() {
        ...
        if ( !location.href.match( $.kwcPath.SESSION_EXPIRED_PAGE ) ) {
