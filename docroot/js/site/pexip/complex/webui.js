...
function createPresentationWindow() {
    if (presentation == null) {
        ...
        $('#presentation-view').html("<img src='' id='loadimage' style='position:absolute;left:0;top:0;display:block;z-index:5;' width='100%' height='100%' onLoad='switchImage();'/><div width='0px' height='0px' style='overflow:auto;position:absolute;left:0;top:0;'><img src='' id='presimage' width='0px'/></div>");
    }
    /*if (presentation == null) {
