/**
  * @fileOverview This file defines the plugin interface module for the VidyoClient wrapper object.
  * @author Vidyo Inc.
  * @version 1.0.1
  * @copyright
...
define(["./vidyo.client.messages-1.0.1"],
	function (vidyoClientMessages) {
		...
		var vidyoClient = function (config) {
			...
			var getSupportedPluginMimeTypes = function () {
				var retVal = [
					"application/x-vidyoweb-1.0.1.00053",
					"application/x-vidyoweb-1.0.1.99999"
				];
				return retVal;
			};
