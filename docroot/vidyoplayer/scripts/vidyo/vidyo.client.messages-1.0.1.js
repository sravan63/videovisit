/**
  * @fileOverview This file defines the messages module for the VidyoClient wrapper object.
  * @author Vidyo Inc.
  * @version 1.0.1
  * @copyright
...
define(["./vidyo.client.parameters-1.0.1"],
	function (vidyoClientParameters) {
		...
		var vidyoClientMessages = {
			...
			/**
			  * Creates a VidyoClient get current Endpoint ID (EID) equest object.
			...
			/**
			  * Sets log levels and categories for the Client API library in plugin object.
			  * Request used to set log levels and categories.
			  *
			  * The passed in parameter object can store the following
			  * properties:<br/>
			...
			'requestSetLogLevelsAndCategories': function (params) {
				...
				// initial values of which are potentially passed
				// into this factory function
				that.levelsAndCategories = params && params.levelsAndCategories || "";
				// return object created by this factory function
				return that;
			},
