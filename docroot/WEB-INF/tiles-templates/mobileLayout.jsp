	...
	<body onorientationchange="">
		...
		<!--  Code for Spinner Animation -->
			...
			<div id="layover" style=" position: fixed; width:100%; height:100%;	background-color:rgba(126, 126, 126, 0.5);	z-index: 10;display:none">
				<div class='uil-default-css' style='-webkit-transform:scale(0.28)'><div style='top:83px;left:93px;width:14px;height:34px;background:#000000;-webkit-transform:rotate(0deg) translate(0,-50px);transform:rotate(0deg) translate(0,-50px);border-radius:10px;position:absolute;'></div><div style='top:83px;left:93px;width:14px;height:34px;background:#000000;-webkit-transform:rotate(36deg) translate(0,-50px);transform:rotate(36deg) translate(0,-50px);border-radius:10px;position:absolute;'></div><div style='top:83px;left:93px;width:14px;height:34px;background:#000000;-webkit-transform:rotate(72deg) translate(0,-50px);transform:rotate(72deg) translate(0,-50px);border-radius:10px;position:absolute;'></div><div style='top:83px;left:93px;width:14px;height:34px;background:#000000;-webkit-transform:rotate(108deg) translate(0,-50px);transform:rotate(108deg) translate(0,-50px);border-radius:10px;position:absolute;'></div><div style='top:83px;left:93px;width:14px;height:34px;background:#000000;-webkit-transform:rotate(144deg) translate(0,-50px);transform:rotate(144deg) translate(0,-50px);border-radius:10px;position:absolute;'></div><div style='top:83px;left:93px;width:14px;height:34px;background:#000000;-webkit-transform:rotate(180deg) translate(0,-50px);transform:rotate(180deg) translate(0,-50px);border-radius:10px;position:absolute;'></div><div style='top:83px;left:93px;width:14px;height:34px;background:#000000;-webkit-transform:rotate(216deg) translate(0,-50px);transform:rotate(216deg) translate(0,-50px);border-radius:10px;position:absolute;'></div><div style='top:83px;left:93px;width:14px;height:34px;background:#000000;-webkit-transform:rotate(252deg) translate(0,-50px);transform:rotate(252deg) translate(0,-50px);border-radius:10px;position:absolute;'></div><div style='top:83px;left:93px;width:14px;height:34px;background:#000000;-webkit-transform:rotate(288deg) translate(0,-50px);transform:rotate(288deg) translate(0,-50px);border-radius:10px;position:absolute;'></div><div style='top:83px;left:93px;width:14px;height:34px;background:#000000;-webkit-transform:rotate(324deg) translate(0,-50px);transform:rotate(324deg) translate(0,-50px);border-radius:10px;position:absolute;'></div></div>
			</div>
