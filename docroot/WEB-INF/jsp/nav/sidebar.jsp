<div id="sidebar-main">
    ...
    <h1>Stay Connected<br />With Your Doctor</h1>
    ...
    <div class="sidebar-nav-wrap">
        <ul>
            ...
            <li>Manage Your Family's Health
                <ul>
                    <li><a target="MDO_ExternalLink" href="http://mydoctor.kaiserpermanente.org/ncal/myfh/myfh_landing.html">Learn How</a></li>
