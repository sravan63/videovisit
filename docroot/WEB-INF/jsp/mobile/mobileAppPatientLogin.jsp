		...
		<form class="login-form" style="margin:6px 0 0;">
			<ul class="form-block">
				...
				<li class="">
					...
					<input type="tel" name="birth_month" id="birth_month" class="mobile-patient-light-auth-inputfield birth_month" maxlength="2" tabindex="3" placeholder="MM" autocorrect="off" pattern="[0-9]*" inputmode="numeric" title="mm" required style="width: 15%;margin-right:12px;">
					<input type="tel" name="birth_year" id="birth_year" class="mobile-patient-light-auth-inputfield birth_year" maxlength="4" tabindex="4" placeholder="YYYY" autocorrect="off" pattern="[0-9]*" inputmode="numeric" title="mm/yyyy" required style="width: 80%;float: right;">
				</li>
