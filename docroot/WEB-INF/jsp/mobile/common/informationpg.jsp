<div class="only-tablets">
	<ol class="well instructions">
		...
		<li><div class="img-app getAppLink"></div><span>Download the latest version of the KP Preventive Care app. <a class="getAppLink" href="#">Get it now</a></span></li>
		<li><div class=""></div><span>After downloading, return to this screen or your email to continue to sign on.</span></li>
		<li><div class="img-connection"></div><span>Make sure you have a good wi-fi connection or 4G.</span></li>
		<li><div class="img-headphones"></div><span>For best results, use headphones for your call.</span></li>
	</ol>
</div>
