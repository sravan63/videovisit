<h3 class="page-title">Member Login</h3>
                    ...
                    <form id="loginForm" method="post" action="">
                        <ul class="form-block">
                            ...
                            <li><label for="captcha">Enter Code Shown</label><img src="assets/images/placeholder-captcha.png" alt="" class="gfx-captcha" /><input type="text" name="captcha" id="captcha" class="captcha"></li>
...
in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. unt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</textarea></li>
                            <li><input type="checkbox" name="visible" value="understand_terms" id="understand_terms" class="understand_terms"><label class="label-understand-terms" for="understand_terms">I have read and agree to the terms of consent above.</label></li>
                        </ul>
