...
<form id="loginForm" method="post" action="">
    ...
    <ul class="form-block">
        ...
        <li><label>Birth Month and Year</label> <label class="label-month" for="birth_month">Month</label><input type="text" name="birth_month" title="mm" id="birth_month" class="birth_month" tabindex="3"> <label class="label-year" for="birth_year">Year</label><input type="text" name="birth_year" title="yyyy" class="birth_year" tabindex="4"></li>
