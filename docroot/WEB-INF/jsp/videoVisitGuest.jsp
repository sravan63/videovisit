					...
					<div style="margin-top:50px; overflow:auto;">
						...
						<div id="downloadStep2" class="downloadSteps" style="display:inline-block; margin:10px 20px; vertical-align:top; opacity:0.4;">
							...
							<span style="display:inline-block; width:145px; margin:0 10px; vertical-align:middle;">
								...
								<a id="winChromePluginFile" href="vidyoplayer/files/VidyoClientForWeb-win32-1.3.1.0062.msi" class="hide" style="font-size:20px; color:#0088cc;">Download Vidyo plug-in</a>
								<a id="macChromePluginFile" href="vidyoplayer/files/VidyoClientForWeb-macosx-x86-1.3.1.0062.pkg" class="hide" style="font-size:20px; color:#0088cc; display:block;" onclick="downloadPlugin();">Download Vidyo plug-in for Mac</a>
							</span>
						</div>
				        ...
				        <div id="inCallContainer" class="container hide">
				            ...
				            <div id="inCallPluginAndControlsWrap">
								...
								<div id="btnContainer" style="display:none;">
				                    ...
				                    <div class="btn-group">
										<a class="btn btn-large btn-tmv-success" href="#" title="Disable Video" id="inCallButtonMuteVideo"></a>
										<a class="btn btn-large btn-tms-success" href="#" title="Mute Speakers" id="inCallButtonMuteSpeaker"></a>
										<a class="btn btn-large btn-tmm-success" href="#" title="Mute Mic" id="inCallButtonMuteMicrophone"></a>
									</div>
		
									<div class="btn-group" style="float:right;">
				                        <!-- <a class="btn btn-large btn-toggle-preview" href="#" title="Toggle Preview ('None', 'PiP', 'Dock')" id="inCallButtonTogglePreview"></a> -->
										<a class="btn btn-large btn-local-share" data-toggle="dropdown" href="#" id="inCallButtonLocalShare" title="Share Desktop" style="border-right:1px solid #D4D4D4;"></a>
