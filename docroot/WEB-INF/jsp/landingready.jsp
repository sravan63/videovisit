...
<c:forEach var="meeting" items="${WebAppContext.meetings}">
    <div class="landing-portal-single-container">
        ...
        <div class="landing-portal-details">
            ...
            <a id="joinbutton" class="btn" meetingid="${meeting.meetingId}" href="https://tpmg.megameeting.com/?page=guest&conid=${meeting.mmMeetingName}&user=&agree=1&reload=1">Click here to join now</a>
