                    ...
                    <div className="row browser-block-content ml-0 mt-4">
                        <div className={this.props.browserblockinfo.isSafari15_1 ? "col-lg-1 col-md-2 col-sm-3 float-left mdo-logo" : 'col-lg-1 col-md-2 col-sm-3 float-left mt-2 mdo-logo'} ></div>
                            ...
                            <div className="col-lg-6 col-md-10 pl-0 app-store-container">
                                ...
                                <span style={{display: !this.props.browserblockinfo.isSafari15_1 ? 'block' : 'none'}} className="android-playstore mt-2"><a className="icon-link" href="https://play.google.com/store/apps/details?id=org.kp.tpmg.preventivecare&amp;hl=en_US" target="_blank"></a></span>
		                    </div>
                    </div>
                </div>
        );
