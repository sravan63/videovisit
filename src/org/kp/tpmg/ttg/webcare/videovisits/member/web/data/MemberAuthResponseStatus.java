...
public class MemberAuthResponseStatus implements Serializable
{
	...
	/**
	 * @param systemFailure the systemFailure to set
	 */
	...
	public String toString() {
		return "MemberAuthResponseStatus [errorId=" + errorId + ", errorCode="
				+ errorCode + ", errorMessage=" + errorMessage + ", success="
				+ success + ", systemFailure=" + systemFailure + "]";
	}
