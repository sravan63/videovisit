...
public class MemberInfo implements Serializable 
{
	...
	/**
	 * @param accountRoleRegion the accountRoleRegion to set
	 */
	...
	/**
	 * @param primaryRegion the primaryRegion to set
	 */
	...
	public String toString() {
		return "MemberInfo [guid=" + guid + ", mrn=" + mrn + ", uid=" + uid
				+ ", displayName=" + displayName + ", firstName=" + firstName
				+ ", lastName=" + lastName + ", middleName=" + middleName
				+ ", region=" + region + ", preferredFirstName="
				+ preferredFirstName + ", epicEmail=" + epicEmail + ", email="
				+ email + ", accountRole=" + accountRole
				+ ", accountRoleRegion=" + accountRoleRegion
