...
public class FailureInfo implements Serializable 
{
	...
	/**
	 * @param authenticationfailed the authenticationfailed to set
	 */
	...
	public String toString() {
		return "FailureInfo [authenticationfailed=" + authenticationfailed
				+ ", accountlocked=" + accountlocked + ", unauthorized="
				+ unauthorized + ", errorCode=" + errorCode + ", errorMsg="
				+ errorMsg + "]";
	}
