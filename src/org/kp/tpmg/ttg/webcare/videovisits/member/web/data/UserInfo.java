...
public class UserInfo implements Serializable 
{
	...
	/**
	 * @param termsAndCondAccepted the termsAndCondAccepted to set
	 */
	...
	/**
	 * @param activationStatusCode the activationStatusCode to set
	 */
	...
	/**
	 * @param disabledReasonCode the disabledReasonCode to set
	 */
	...
	/**
	 * @param epicEmail the epicEmail to set
	 */
	...
	public String toString() {
		return "UserInfo [region=" + region + ", lastName=" + lastName
				+ ", termsAndCondAccepted=" + termsAndCondAccepted
				+ ", activationStatusCode=" + activationStatusCode
				+ ", preferredFirstName=" + preferredFirstName + ", guid="
				+ guid + ", email=" + email + ", ebizAccountRoles="
				+ ebizAccountRoles + ", disabledReasonCode="
				+ disabledReasonCode + ", firstName=" + firstName
				+ ", epicEmail=" + epicEmail + ", serviceArea=" + serviceArea
				+ ", age=" + age + "]";
	}
