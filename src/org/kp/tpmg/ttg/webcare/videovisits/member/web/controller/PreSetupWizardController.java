...
public class PreSetupWizardController extends SimplePageController {
	...
	public PreSetupWizardController() {
		try {
			...
			logger.debug("PreSetupWizardController -> configuration: resource bundle exists -> video visit external properties file location: "
			...
			logger.error("PreSetupWizardController -> Error while reading external properties file - " + ex.getMessage(), ex);
		}
	}
