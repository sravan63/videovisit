...
public class VendorPluginDTO implements Serializable {
	...
	/**
	 * @param vendorNewPlugin the vendorNewPlugin to set
	 */
	...
	/**
	 * @param vendorOldPlugins the vendorOldPlugins to set
	 */
	...
	/**
	 * @param vendorPluginName the vendorPluginName to set
	 */
	...
	public String toString() {
		return "VendorPluginDTO [vendorPluginName=" + vendorPluginName
				+ ", vendorNewPlugin=" + vendorNewPlugin
