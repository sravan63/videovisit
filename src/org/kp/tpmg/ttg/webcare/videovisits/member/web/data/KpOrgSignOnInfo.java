...
public class KpOrgSignOnInfo implements Serializable {
	...
	public String toString() {
		return "KpOrgSignOnInfo [systemError=" + systemError
				+ ", interruptList=" + interruptList + ", success=" + success
				+ ", businessError=" + businessError + ", user=" + user
				+ ", failureInfo=" + failureInfo + ", ssoSession=" + ssoSession
				+ "]";
	}
