...
public class KpOrgAuthMember implements Serializable 
{
	...
	/**
	 * @param memberAuthResponseStatus the memberAuthResponseStatus to set
	 */
	public void setMemberAuthResponseStatus(
			MemberAuthResponseStatus memberAuthResponseStatus) {
